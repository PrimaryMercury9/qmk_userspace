#/bin/bash
if [ ! -d $HOME/.qmk_firmware/keyboards/crkbd/keymaps/primarymercury9 ]; then
    mkdir $HOME/.qmk_firmware/keyboards/crkbd/keymaps/primarymercury9
fi

cd $HOME/.qmk_firmware

if [[ "$OSTYPE" == "linux-gnu"* ]]; then
    ln -sf $HOME/Documents/01-Projects/keyboards/mymaps/corne/rules.mk  $HOME/.qmk_firmware/keyboards/crkbd/keymaps/primarymercury9/rules.mk
    ln -sf $HOME/Documents/01-Projects/keyboards/mymaps/corne/config.h  $HOME/.qmk_firmware/keyboards/crkbd/keymaps/primarymercury9/config.h
    ln -sf $HOME/Documents/01-Projects/keyboards/mymaps/corne/keymap.c  $HOME/.qmk_firmware/keyboards/crkbd/keymaps/primarymercury9/keymap.c
    ...
    ln -sf $HOME/Documents/01-Projects/keyboards/mymaps/corne/info.json  $HOME/.qmk_firmware/keyboards/crkbd/info.json
...
#    ln -sf $HOME/Documents/01-Projects/keyboards/mymaps/kyria/graph.h  $HOME/.qmk_firmware/keyboards/splitkb/kyria/keymaps/primarymercury9/graph.h
    qmk compile -kb crkbd/rev4 -km primarymercury9 -e CONVERT_TO=elite_pi -j4
